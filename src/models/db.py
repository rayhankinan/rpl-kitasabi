...
with app.app_context():
    ...
    cursor.execute("CREATE TABLE AkunNoTelp (IDPengguna INT UNSIGNED, NoTelp VARCHAR(31), PRIMARY KEY (IDPengguna, NoTelp), FOREIGN KEY (IDPengguna) REFERENCES Akun (IDPengguna) ON DELETE CASCADE)")
